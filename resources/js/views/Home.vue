<template>
  ...
  <div class="welcome">
        <div class="box--1">
          ...
          <div class="color">
            <span class="_green">Colour</span>
            <span class="_yellow">Your</span>
            <span class="_red">World</span>
          </div>
        </div>
        <div class="box--2">
      ...
      <div class="services">
        <div class="service--1">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" id="1209830789" class="svg u_1209830789" data-icon-name="li_paint_roller"> <path d="M86.2,43.4L56.6,13.8c-2.4-2.4-6.7-2.4-9.1,0L36.4,24.9c-2.5,2.5-2.5,6.6,0,9.1L66,63.6c1.2,1.2,2.8,1.9,4.6,1.9
	...
	c1.1,0,2.1,0.4,2.8,1.2l29.6,29.6C86,46.7,86,49.2,84.4,50.8z" id="1321686744"></path> 
</svg>
        ...
        <div class="service--2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 70" id="1822776629" class="svg u_1822776629" data-icon-name="wp-question_mark_thin"> <g id="1149379259"> <circle cx="35" cy="47" r="2" id="1373409117"></circle> 
 <path d="M35,42c-0.6,0-1-0.4-1-1c0-3.2,2.2-4.8,4.2-6.3c2-1.5,3.8-2.8,3.8-5.5c0-3.6-2.9-6.2-7-6.2c-4.1,0-7,2.9-7,7
		c0,0.6-0.4,1-1,1c-0.6,0-1-0.4-1-1c0-5.2,3.8-9,9-9c5.2,0,9,3.4,9,8.2c0,3.7-2.4,5.5-4.6,7.1C37.6,37.7,36,38.8,36,41
		C36,41.6,35.6,42,35,42z" id="1158749410"></path> 
 <path d="M35,60c-13.8,0-25-11.2-25-25s11.2-25,25-25c13.8,0,25,11.2,25,25S48.8,60,35,60z M35,12c-12.7,0-23,10.3-23,23
		s10.3,23,23,23c12.7,0,23-10.3,23-23S47.7,12,35,12z" id="1940391037"></path> 
</g> 
</svg>
          <h3>Why Choose Us?</h3>
          <ul class="list">
            ...
            <li>Customer care is our focus point</li>
            <li>1 year guarantee on all services</li>
          </ul>
        </div>
        <div class="service--3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" id="1391966636" class="svg u_1391966636" data-icon-name="li_tools"> <path d="M84.9,63.5c-2.3-2.3-5.3-3.6-8.6-3.6c-2.9,0-5.6,1-7.7,2.9L55.8,50l21.3-21.3l0.8,0.8l7.8-7.8l-3.1-3.1l-7.8,7.8l0.8,0.8
	...
	c2,2,3,4.7,2.9,7.6L80.2,66.6z" id="1495565370"></path> 
</svg>
          <h3>Home Maintenance &amp; More</h3>
          <p>
...
.box--1 {
  ...
  // background-image: linear-gradient(45deg, #3ea8ff 0%, #04bb62 32%, #fdf943 66%, #fb4343 99%);
